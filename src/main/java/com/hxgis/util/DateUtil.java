...
public class DateUtil
{
	...
	public final static int DAY_TIME_INTERVAL = 0;
	public final static int WEEK_TIME_INTERVAL = 1;
	public final static int MONTH_TIME_INTERVAL = 2;
	...
	public static Double diff(Date end, Date begin, int field)
	{
		if (end == null || begin == null)
			return null;


		double interval = end.getTime() - begin.getTime();

		if (field == GregorianCalendar.DATE)
			return interval / (1000 * 60 * 60 * 24);
		else if (field == GregorianCalendar.HOUR)
			return interval / (1000 * 60 * 60);
		else if (field == GregorianCalendar.MINUTE)
			return interval / (1000 * 60 );
		else if (field == GregorianCalendar.SECOND)
	 ...
	 */
	public static String  getStartTime(Date dt, int timeInterval) {
	...
	public static Date  getStartTime2(Date dt, int timeInterval) {
		Calendar cal = Calendar.getInstance();
		SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
		cal.setTime(dt);
