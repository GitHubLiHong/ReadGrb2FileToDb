...
public class Constant {
    ...
    public static final double GRB2_LATGAP = 0.05;//0.025
    public static final int GRB2_XSIZE = 229;//321
    public static final int GRB2_YSIZE = 170;//181
